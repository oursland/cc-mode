...
;; Version:         $Revision: 3.57 $
;; Last Modified:   $Date: 1993-11-17 20:14:40 $
...
;; |$Date: 1993-11-17 20:14:40 $|$Revision: 3.57 $|
...
(defun cc-c++-mode ()
  "Major mode for editing C++ code.  $Revision: 3.57 $
...
(defun cc-c-mode ()
  "Major mode for editing K&R and ANSI C code.  $Revision: 3.57 $
To submit a problem report, enter `\\[cc-submit-bug-report]' from a
cc-c-mode buffer.  This automatically sets up a mail buffer with
version information already added.  You just need to add a description
of the problem and send the message.
...
(defconst cc-version "$Revision: 3.57 $"
